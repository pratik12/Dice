...
ssh -o "StrictHostKeyChecking no" -i DeployKeyPair.pem ec2-user@ec2-13-59-122-224.us-east-2.compute.amazonaws.com 'bash -s' < "cd && cd Dice && pm2 stop all && git pull && cd bin && npm start"
